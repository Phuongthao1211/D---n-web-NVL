            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active font-16">Sửa khuyến mãi</li>
                    </ol>
                </div>
                <h2 class="page-title font-24">Sửa khuyến mãi</h2>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="form-row-preview">
                            <form action="{{route('khuyenmai.update',['id'=>$khuyenmai->id])}}" method="post" class="font-16">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="tab-pane show active" id="striped-rows-preview">
                                            <div class="form-floating mb-3">
                                                <input name="name" type="text" class="form-control" id="floatingInput" placeholder="Tên khuyến mãi" value="{{$khuyenmai->name}}" required/>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="tab-pane show active" id="striped-rows-preview">
                                            <div class="form-floating mb-3">
                                                <input value="{{$ngaybd}}" name="ngaybd" type="datetime-local" class="form-control" id="floatingInput" placeholder="Ngày bắt đầu" required/>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="tab-pane show active" id="striped-rows-preview">
                                            <div class="form-floating mb-3">
                                                <input value="{{$ngaykt}}" name="ngaykt" type="datetime-local" class="form-control" id="floatingInput" placeholder="Ngày kết thúc" required/>

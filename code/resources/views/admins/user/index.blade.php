            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active font-16">Tài khoản user</li>
                    </ol>
                </div>
                <h2 class="page-title font-24">Tài khoản user</h2>
            </div>
        </div>
    </div>
    <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    @endif
                                                    <label for="{{'switch'.$user->id}}" data-url="{{route('admins.user.active')}}" data-id="{{$user->id}}" data-on-label="Yes" data-off-label="No" class="mb-0 d-block active_user"></label>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
